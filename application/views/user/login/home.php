				...
				<div class="col-md-3 text-center ftco-animate">
					<div class="menu-wrap">
						...
						<div class="text">
							...
							<p><a href="<?php echo site_url('user_login/detail_produk/' . $produk->id_produk) ?>" class="btn btn-white btn-outline-white">Sewa</a></p>
						</div>
					</div>
				</div>
			<?php
				...
				<div class="col-md-3 text-center ftco-animate">
					<div class="menu-wrap">
						...
						<div class="text">
							...
							<p>Stok : <?php echo $produk->stok ?></p>
							<p class="price"><span><?php echo 'Rp. ' . number_format($produk->harga) ?></span></p>
							<p><a href="<?php echo site_url('user_login/form_produk/' . $produk->id_produk) ?>" class="btn btn-white btn-outline-white">Daftar</a></p>
						</div>
					</div>
				</div>
			<?php
