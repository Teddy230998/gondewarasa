      ...
      <div class="container">
        ...
        ?>
          <div class="col-md-4 d-flex ftco-animate">
              ...
              <a href="<?php echo site_url('home/bacaberita/'.$agenda->id_agenda) ?>" class="block-20" style="background-image: url('<?php echo base_url(); ?>user/baca_berita/<?php echo $agenda->foto_agenda ?>');">
              </a>
              <div class="text py-4 d-block">
                ...
                <h3 class="heading mt-2"><a href="<?php echo base_url(); ?>user/baca_berita/" style="color: black"><?php echo $agenda->judul_agenda ?></a></h3>
